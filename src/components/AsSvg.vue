  ...
  <g>
      ...
      <g>
          ...
          <g>
              ...
              <text class="textbold colorblack" x="440" y="290" @click="goto('https://www.christian-riedl.com/identity4/')">Identity-Service</text>
          </g>
          <g>
              ...
              <text class="textbold colorblack" x="440" y="330" @click="goto('https://www.christian-riedl.com/photos/speedtest')">Foto-Service</text>
          </g>
          <g>
              ...
              <text class="textbold colorblack" x="535" y="330" @click="goto('https://www.christian-riedl.com/nextpwa/')">UI-Service</text>
          </g>
          <g>
              ...
              <text class="textbold colorblack" x="625" y="330" @click="goto('https://www.christian-riedl.com/birdapp/')">BIRDS</text>
          </g>
      </g>
      <g>
